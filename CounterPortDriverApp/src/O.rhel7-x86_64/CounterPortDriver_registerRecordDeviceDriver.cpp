...
/* Generated from ../O.Common/CounterPortDriver.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "asynInt64In", "devI64outSoft", "devI64outSoftCallback",
...
int CounterPortDriver_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/afs/slac.stanford.edu/u/cd/lujko/LukasPortTest";
